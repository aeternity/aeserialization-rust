...
impl Instruction {
    ...
    pub fn args(&self) -> Vec<crate::code::Arg> {
        ...
        match self {
            ...
            CALL_R(a1, a2, a3, a4, a5) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone(), a5.clone()],
            CALL_T(a1) => vec![a1.clone()],
            CALL_GR(a1, a2, a3, a4, a5, a6) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone(), a5.clone(), a6.clone()],
            JUMP(a1) => vec![a1.clone()],
            JUMPIF(a1, a2) => vec![a1.clone(), a2.clone()],
            SWITCH_V2(a1, a2, a3) => vec![a1.clone(), a2.clone(), a3.clone()],
            SWITCH_V3(a1, a2, a3, a4) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone()],
            SWITCH_VN(a1, a2) => vec![a1.clone(), a2.clone()],
            CALL_VALUE => vec![],
            ...
            MAP_EMPTY => vec![],
            MAP_LOOKUP(a1, a2) => vec![a1.clone(), a2.clone()],
            MAP_LOOKUPD(a1, a2, a3) => vec![a1.clone(), a2.clone(), a3.clone()],
            MAP_UPDATE(a1, a2, a3) => vec![a1.clone(), a2.clone(), a3.clone()],
            MAP_DELETE(a1, a2) => vec![a1.clone(), a2.clone()],
            MAP_MEMBER(a1, a2) => vec![a1.clone(), a2.clone()],
            MAP_FROM_LIST(a1) => vec![a1.clone()],
            MAP_SIZE(a1) => vec![a1.clone()],
            MAP_TO_LIST(a1) => vec![a1.clone()],
            IS_NIL(a1) => vec![a1.clone()],
            ...
            STR_JOIN(a1, a2) => vec![a1.clone(), a2.clone()],
            INT_TO_STR(a1) => vec![a1.clone()],
            ADDR_TO_STR(a1) => vec![a1.clone()],
            STR_REVERSE(a1) => vec![a1.clone()],
            STR_LENGTH(a1) => vec![a1.clone()],
            BYTES_TO_INT(a1) => vec![a1.clone()],
            BYTES_TO_STR(a1) => vec![a1.clone()],
            BYTES_CONCAT(a1, a2) => vec![a1.clone(), a2.clone()],
            BYTES_SPLIT(a1, a2) => vec![a1.clone(), a2.clone()],
            INT_TO_ADDR(a1) => vec![a1.clone()],
            VARIANT(a1, a2, a3) => vec![a1.clone(), a2.clone(), a3.clone()],
            VARIANT_TEST(a1, a2) => vec![a1.clone(), a2.clone()],
            VARIANT_ELEMENT(a1, a2) => vec![a1.clone(), a2.clone()],
            BITS_NONEA => vec![],
            BITS_NONE => vec![],
            BITS_ALLA => vec![],
            BITS_ALL => vec![],
            BITS_ALL_N(a1) => vec![a1.clone()],
            BITS_SET(a1, a2) => vec![a1.clone(), a2.clone()],
            BITS_CLEAR(a1, a2) => vec![a1.clone(), a2.clone()],
            BITS_TEST(a1, a2) => vec![a1.clone(), a2.clone()],
            BITS_SUM(a1) => vec![a1.clone()],
            BITS_OR(a1, a2) => vec![a1.clone(), a2.clone()],
            BITS_AND(a1, a2) => vec![a1.clone(), a2.clone()],
            BITS_DIFF(a1, a2) => vec![a1.clone(), a2.clone()],
            BALANCE => vec![],
            ORIGIN => vec![],
            CALLER => vec![],
            ...
            ORACLE_REGISTER(a1, a2, a3, a4, a5, a6) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone(), a5.clone(), a6.clone()],
            ORACLE_QUERY(a1, a2, a3, a4, a5, a6, a7) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone(), a5.clone(), a6.clone(), a7.clone()],
            ORACLE_RESPOND(a1, a2, a3, a4, a5, a6) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone(), a5.clone(), a6.clone()],
            ORACLE_EXTEND(a1, a2, a3) => vec![a1.clone(), a2.clone(), a3.clone()],
            ORACLE_GET_ANSWER(a1, a2, a3, a4) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone()],
            ORACLE_GET_QUESTION(a1, a2, a3, a4) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone()],
            ORACLE_QUERY_FEE(a1) => vec![a1.clone()],
            AENS_RESOLVE(a1, a2, a3) => vec![a1.clone(), a2.clone(), a3.clone()],
            AENS_PRECLAIM(a1, a2, a3) => vec![a1.clone(), a2.clone(), a3.clone()],
            AENS_CLAIM(a1, a2, a3, a4, a5) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone(), a5.clone()],
            AENS_UPDATE(a1, a2, a3, a4, a5, a6) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone(), a5.clone(), a6.clone()],
            AENS_TRANSFER(a1, a2, a3, a4) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone()],
            AENS_REVOKE(a1, a2, a3) => vec![a1.clone(), a2.clone(), a3.clone()],
            BALANCE_OTHER(a1) => vec![a1.clone()],
            VERIFY_SIG(a1, a2, a3) => vec![a1.clone(), a2.clone(), a3.clone()],
            VERIFY_SIG_SECP256K1(a1, a2, a3) => vec![a1.clone(), a2.clone(), a3.clone()],
            CONTRACT_TO_ADDRESS(a1) => vec![a1.clone()],
            AUTH_TX_HASH => vec![],
            ORACLE_CHECK(a1, a2, a3) => vec![a1.clone(), a2.clone(), a3.clone()],
            ORACLE_CHECK_QUERY(a1, a2, a3, a4) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone()],
            IS_ORACLE(a1) => vec![a1.clone()],
            IS_CONTRACT(a1) => vec![a1.clone()],
            IS_PAYABLE(a1) => vec![a1.clone()],
            CREATOR => vec![],
            ECVERIFY_SECP256K1(a1, a2, a3) => vec![a1.clone(), a2.clone(), a3.clone()],
            ECRECOVER_SECP256K1(a1, a2) => vec![a1.clone(), a2.clone()],
            ADDRESS_TO_CONTRACT(a1) => vec![a1.clone()],
            BLS12_381_G1_NEG(a1) => vec![a1.clone()],
            BLS12_381_G1_NORM(a1) => vec![a1.clone()],
            BLS12_381_G1_VALID(a1) => vec![a1.clone()],
            BLS12_381_G1_IS_ZERO(a1) => vec![a1.clone()],
            BLS12_381_G1_ADD(a1, a2) => vec![a1.clone(), a2.clone()],
            BLS12_381_G1_MUL(a1, a2) => vec![a1.clone(), a2.clone()],
            BLS12_381_G2_NEG(a1) => vec![a1.clone()],
            BLS12_381_G2_NORM(a1) => vec![a1.clone()],
            BLS12_381_G2_VALID(a1) => vec![a1.clone()],
            BLS12_381_G2_IS_ZERO(a1) => vec![a1.clone()],
            BLS12_381_G2_ADD(a1, a2) => vec![a1.clone(), a2.clone()],
            BLS12_381_G2_MUL(a1, a2) => vec![a1.clone(), a2.clone()],
            BLS12_381_GT_INV(a1) => vec![a1.clone()],
            BLS12_381_GT_ADD(a1, a2) => vec![a1.clone(), a2.clone()],
            BLS12_381_GT_MUL(a1, a2) => vec![a1.clone(), a2.clone()],
            BLS12_381_GT_POW(a1, a2) => vec![a1.clone(), a2.clone()],
            BLS12_381_GT_IS_ONE(a1) => vec![a1.clone()],
            BLS12_381_PAIRING(a1, a2) => vec![a1.clone(), a2.clone()],
            BLS12_381_MILLER_LOOP(a1, a2) => vec![a1.clone(), a2.clone()],
            BLS12_381_FINAL_EXP(a1) => vec![a1.clone()],
            BLS12_381_INT_TO_FR(a1) => vec![a1.clone()],
            BLS12_381_INT_TO_FP(a1) => vec![a1.clone()],
            BLS12_381_FR_TO_INT(a1) => vec![a1.clone()],
            BLS12_381_FP_TO_INT(a1) => vec![a1.clone()],
            AENS_LOOKUP(a1) => vec![a1.clone()],
            ORACLE_EXPIRY(a1) => vec![a1.clone()],
            AUTH_TX => vec![],
            STR_TO_LIST(a1) => vec![a1.clone()],
            STR_FROM_LIST(a1) => vec![a1.clone()],
            STR_TO_UPPER(a1) => vec![a1.clone()],
            STR_TO_LOWER(a1) => vec![a1.clone()],
            CHAR_TO_INT(a1) => vec![a1.clone()],
            CHAR_FROM_INT(a1) => vec![a1.clone()],
            CALL_PGR(a1, a2, a3, a4, a5, a6, a7) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone(), a5.clone(), a6.clone(), a7.clone()],
            CREATE(a1, a2, a3) => vec![a1.clone(), a2.clone(), a3.clone()],
            CLONE(a1, a2, a3, a4) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone()],
            CLONE_G(a1, a2, a3, a4, a5) => vec![a1.clone(), a2.clone(), a3.clone(), a4.clone(), a5.clone()],
            BYTECODE_HASH(a1) => vec![a1.clone()],
            FEE => vec![],
            ADDRESS_TO_BYTES(a1) => vec![a1.clone()],
            ...
            BYTES_SPLIT_ANY(a1, a2) => vec![a1.clone(), a2.clone()],
            BYTES_SIZE(a1) => vec![a1.clone()],
            BYTES_TO_FIXED_SIZE(a1, a2) => vec![a1.clone(), a2.clone()],
            INT_TO_BYTES(a1, a2) => vec![a1.clone(), a2.clone()],
            STR_TO_BYTES(a1) => vec![a1.clone()],
            DBG_LOC(a1, a2) => vec![a1.clone(), a2.clone()],
            DBG_DEF(a1, a2) => vec![a1.clone(), a2.clone()],
            DBG_UNDEF(a1, a2) => vec![a1.clone(), a2.clone()],
            DBG_CONTRACT(a1) => vec![a1.clone()],
            DEACTIVATE => vec![],
